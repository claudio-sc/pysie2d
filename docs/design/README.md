...
| [v0.6-architecture.md](v0.6-architecture.md) | v0.6 doc A — decisions, scope, the `Parametrisation` object, the API break, the non-goals. | **Live.** Decisions taken; items 2 (analytic `ddf`/`ddg`) and 3 (`Parametrisation`) implemented, items 1, 4–8 not. |
