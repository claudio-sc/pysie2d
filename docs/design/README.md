...
| [multipole-spec.md](multipole-spec.md) | v0.7 code-spec for the multipole decomposition of the scattered field: the measured Mie relation, the three guards the legacy code lacked, and the full implementation. | **Live**, draft 1. Not implemented. |
