...
| [v0.8-external-validation.md](v0.8-external-validation.md) | v0.8 high-level spec: the comparison contract, MEEP and dolfinx as the two anchors split by regime, the five gates, and the three-layer packaging. Renumbered from v0.7 on 20 Sep 2026. | **Live.** Scoping; no code-spec yet. |
